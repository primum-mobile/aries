...
class FixStars:
	...
	def __init__(self, tjd_ut, flag, names, obl, ayanamsha_offset=0.0):
		...
		for k in names.keys():
			...
			tropical_lon = util.to_tropical_lon(dat[0], ayanamsha_offset)
			ra, decl, dist = astrology.swe_cotrans(tropical_lon, dat[1], 1.0, -obl)
