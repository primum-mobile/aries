...
const buttonVariants = cva(
  "aries-desktop-focus group/button inline-flex shrink-0 items-center justify-center rounded-[var(--aries-radius-ui-control)] border border-transparent bg-clip-padding text-[length:var(--aries-font-size-control)] font-medium whitespace-nowrap transition-all outline-none select-none active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-[var(--aries-control-icon-size-default)]",
  {
    variants: {
      variant: {
