...
MENU_LABEL_KEYS: dict[str, str] = {
    ...
    "Rings": "chartmenu.rings",
    "Multi-wheel": "chartmenu.multiwheel",
    "Show multi-wheel": "chartmenu.showMultiwheel",
    "Two rings": "chartmenu.twoRings",
    "Three rings": "chartmenu.threeRings",
    "Four rings": "chartmenu.fourRings",
    "Zodiac outermost": "chartmenu.zodiacOutermost",
    "Zodiac innermost": "chartmenu.zodiacInnermost",
    "Harmonic": "toolbar.navbar.unit.harmonic",
    "Harmonic chart": "chartmenu.harmonicChart",
    "Vargas": "chartmenu.vargas",
    "Harmonic number": "chartmenu.harmonicNumber",
    ...
    "Fortune Houses": "chartmenu.hsFortuneWholeSign",
