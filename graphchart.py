...
class GraphChart:
	...
	def __init__(self, chrt, size, opts, bw, planetaryday=True, chrt2 = None):
		...
		self.fntAspects = ImageFont.truetype(common.common.symbols, _fs(self.symbolSize/2))
		...
		self.fntSmallText = ImageFont.truetype(common.common.abc, _fs(self.symbolSize/4))
