...
class PlacidianSpeculum:
	...
	LON, LAT, RA, DECL, ADLAT, SA, MD, HD, TH, HOD, PMP, ADPH, POH, AODO, PL_AZM, PL_ELV = range(0, 16)
	...
	def __init__(self, placelat, ascmc2, lon, lat, ra, decl):
		...
		self.speculum = (lon, lat, ra, decl, adlat, sa, md, hd, th, hod, pmp, adphi, phi, ao, AZM, ELV)
