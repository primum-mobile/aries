...
def compute_fixedstar_angle_rows(horoscope, options, age_range=None, direction=None):
    ...
    for code in codes:
        ...
        # UTP and topocentric engines are zodiacal-only; for fix-star-to-angle
        # directions the math falls back to Placidian semiarc.
        if pd_method == primdirs.PrimDirs.PLACIDIANUNDERTHEPOLE or pd_method == primdirs.PrimDirs.TOPOCENTRIC:
